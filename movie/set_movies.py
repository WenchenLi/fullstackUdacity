...
forrest_gump = Movie("https://upload.wikimedia.org/wikipedia/en/6/67/Forrest_Gump_poster.jpg",
                     ...
                     "Tom Hanks stars as the good hearted, but painfully slow Forrest Gump, a man who manages to somehow be involved with almost every major event in history during the last half of the 20th Century. Spanning the course of his life,	the story follows him as he grows from a weak child to a war hero to a shrimp boat captain, all the while pining for the love of his childhood friend Jenny, played by Robin Wright.",
                     "Forrest Gump")
